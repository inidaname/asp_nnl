...
<%
    ...
    If IsPostBack = False Then
        dsfrontpagemain = GenTool.DataSetData("select sysID,HeaderName,BriefMsg,FullMessage,sysImageName from frontpagemain where Status=1 ANd gDesign=0 order by sysID asc")
    End If
    ...
    <div id="content">
                        ...
                        <div class="green">  
                            <ul id="mega-menu-9" class="mega-menu" style ="background-color:#F7F7F7">
                                ...
                                <% 
                                    ...
                                    Else
                                        Response.Write("<li><a href='contactus.aspx'>Contact Us</a></li>")
                                    End If
                                    
                                    Response.Write("<li><a href='" & regedit & "'>" & regcomp & "</a></li>")
                                    Response.Write("<li><a href='" & degDV & "'>" & regDevice & "</a></li>")
                                    If String.IsNullOrEmpty(Session("ID")) = False Then Response.Write("<li><a href='devicereports.aspx'>Reports</a></li>")
		...
		<div id="main_page">
           ...
           If String.IsNullOrEmpty(Session("ID")) = False Then
               ...
               Response.Write(GenTool23.getStatusBar(Me.Page, True))
               %>  
...
<div id="main-menu">
	...
	<div id="item2" runat ="server">
     ...
     <%--   <asp:Timer ID="Timer1" runat="server" Enabled ="true" Interval ="2000"  > </asp:Timer>--%>
    	...
    	<div class="item_content" runat="server">

             <div  runat ="server" id="content_left">&nbsp;</div>

             <%   
                 Dim GenToolx1 As NNLN = xsmsCentralToolx.SetTool
                 GenToolx1.getNextdsFrontPage()
                 If GenToolx1.HasDatasetAnyRecord(dsfrontpagemainFs4) = False Then
             ...
             <% If s1 <> "" Then%>
               ...
               <div id="item_left1" class="style1"  >
             ...
             <%    
              ...
              %>
                  ...
                  <%
                      ...
                      Dim fVb As String = ""
                      fVb = "<a href='frontpagedisplay.aspx?msgid=" & sd1 & "'><img src='" & docLink & "frontdoc/" & n1.Trim & " ' width='150px' height='150px' align='left' style='border:1px solid #DBDBDB'/> </a>"
                      Response.Write(fVb)
                 ...
                 <% Response.Write("<a href='frontpagedisplay.aspx?msgid=" & sd1 & "'>read more</a><br />")%>
            ...
            <% If s2 <> "" Then%>
               ...
               <div id="item_right1" class="style1"  >
                 <div style="font-family: calibri; font-size: small" class="style11"  >&nbsp;
                 <strong> 
             <%    
                 Dim vsm As String = "<a href='frontpagedisplay.aspx?msgid=" & sd2 & "'><span class='style3'><left>" & s2.Trim & "</left></span></a>"
                 Response.Write(vsm)
              %>
                  ...
                  <%
                      Dim fVb As String = ""
                      fVb = "<a href='frontpagedisplay.aspx?msgid=" & sd2 & "'><img src='" & docLink & "frontdoc/" & n2.Trim & " ' width='150px' height='150px' align='left' style='border:1px solid #DBDBDB'/> </a>"
                      Response.Write(fVb)
                  ...
                  %>  
                   ...
                   <% Response.Write("<a href='frontpagedisplay.aspx?msgid=" & sd2 & "'>read more</a><br />")%>
              ...
              <% If s3 <> "" Then%>
               ...
               <div id="item_left2" class="style1"  >
                 <div style="font-family: calibri; font-size: small" class="style11"  >&nbsp;
                 <strong>
             <%    
                 Dim vsm As String = "<a href='frontpagedisplay.aspx?msgid=" & sd3 & "'><span class='style3'><left>" & s3 & "</left></span></a>"
                 Response.Write(vsm)
              %>
                  ...
                  <%
                      Dim fVb As String = ""
                      fVb = "<a href='frontpagedisplay.aspx?msgid=" & sd3 & "'><img src='" & docLink & "frontdoc/" & n3.Trim & " ' width='150px' height='150px' align='left' style='border:1px solid #DBDBDB'/> </a>"
                      Response.Write(fVb)
                  ...
                  %>  
                   ...
                   <% Response.Write("<a href='frontpagedisplay.aspx?msgid=" & sd3 & "'>read more</a><br />")%>
           ...
           <% If s4 <> "" Then%>
               ...
               <div id="item_right2" class="style1" >
                 <div style="font-family: calibri; font-size: small" class="style11"  >&nbsp;
                 <strong>
             <%    
                 Dim vsm As String = "<a href='frontpagedisplay.aspx?msgid=" & sd4 & "'><span class='style3'><left>" & s4 & "</left></span></a>"
                 Response.Write(vsm)
              %>
                  ...
                  <%
                      Dim fVb As String = ""
                      fVb = "<a href='frontpagedisplay.aspx?msgid=" & sd4 & "'><img src='" & docLink & "frontdoc/" & n4.Trim & " ' width='150px' height='150px' align='left' style='border:1px solid #DBDBDB'/> </a>"
                      Response.Write(fVb)
                  ...
                  %>  
                   ...
                   <% Response.Write("<a href='frontpagedisplay.aspx?msgid=" & sd4 & "'>read more</a><br />")%>
    	...
    	<div class="item_content"><p><a href="#"></a></p></div>
         <ul style="list-style-image:url(images/list2.png); padding:10px 0px 10px 30px">
            ...
            <li>
             ...
             <li class="style2"><a href="viewarchivegroups.aspx?state=0" class="style2"><strong>Archive</strong></a>
             <li class="style2"><a href="quiz.aspx" class="style2"><strong>Quiz</strong></a>
        </ul>
    </div>
