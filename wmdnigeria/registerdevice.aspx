<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/companynoheader.master" CodeFile="registerdevice.aspx.vb" Inherits="registerdevice" %>
                    ...
                    <asp:Panel ID="Panel2" runat="server">
                       <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    &nbsp;</td>
                                <td class="style39" style="width: 129px">
                                    &nbsp;</td>
                                <td class="style41">
                                    &nbsp;</td>
                                <td class="style22">
                            ...
                            <tr>
                                ...
                                <td class="style39" style="width: 129px">
                                    <asp:Label ID="Label26" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Instrument:" ToolTip="Measurement Parameters"></asp:Label>
                                </td>
                                <td class="style41">
                            ...
                            <tr>
                                ...
                                <td class="style41">
                                    <asp:DropDownList ID="ddlUnitOfMeasure" runat="server" 
                                        ValidationGroup="UnitOfMeasureID||1">
                            ...
                            <tr>
                                ...
                                <td class="style39" style="width: 129px">
                                    <asp:Label ID="Label24" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Actual Measurement:"></asp:Label>
                                </td>
                                <td class="style41" colspan="2">
                                    <asp:TextBox ID="txtActualMeasure" runat="server" 
                                        ToolTip="enter actual Instrument measure" 
                                        ValidationGroup="actualMeasure|Invalid Actual Measure" Width="204px"></asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="txtActualMeasure_FilteredTextBoxExtender" 
                                        runat="server" Enabled="True" TargetControlID="txtActualMeasure" 
                            ...
                            <tr>
                                ...
                                <td class="style41" colspan="2">
                                    <asp:DropDownList ID="cboProcessFluid" runat="server" AutoPostBack="True" 
                                        ...
                                        <asp:ListItem>Refined Products</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td class="style41" colspan="2">
