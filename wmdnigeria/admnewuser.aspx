                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:CheckBox ID="chkISP7" runat="server" Font-Names="Calibri" 
                                        Font-Size="Small" Text="Can Update Carrear?" 
                                        ValidationGroup="CarrearRight" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:CheckBox ID="chkISP14" runat="server" Font-Names="Calibri" 
                                        Font-Size="Small" Text="Admin Registration" ValidationGroup="AdmRegistration" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    &nbsp;</td>
                                <td align="left" style="width: 228px">
                                    <asp:CheckBox ID="chkISP13" runat="server" Font-Names="Calibri" 
                                        Font-Size="Small" Text="Invoice History" ValidationGroup="AccountsReport" />
                                </td>
                                <td align="left">
                                    <asp:CheckBox ID="chkISP15" runat="server" Font-Names="Calibri" 
                                        Font-Size="Small" Text="Add Export Permit Msg" 
                                        ValidationGroup="ExportAlertright" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
