<%@ Page Title="Download Manager" Language="VB" MasterPageFile="~/adminpage.master" AutoEventWireup="True" CodeFile="downloadcenter.aspx.vb" EnableEventValidation ="false" Inherits="downloadcenter"   %>
                        ...
                        <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td bgcolor="#99A6B4" colspan="5">
                                    <div class="item_title">&nbsp;&nbsp;&nbsp;DOWNLOAD MANAGER</div>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Label ID="Label8" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Download Type:"></asp:Label>
                                </td>
                                <td align="left">
                                    <asp:DropDownList ID="cbolot" runat="server" Font-Names="Calibri" 
                                        Font-Size="Small" ValidationGroup="d_type|Please select download type" 
                                        Width="210px">
                                        <asp:ListItem Selected="True">SELECT VALUE</asp:ListItem>
                                        <asp:ListItem>REGISTERED MEMBERS</asp:ListItem>
                                        <asp:ListItem>NON REGISTERED MEMBERS</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    &nbsp;</td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtfilename" runat="server" 
                                        ValidationGroup="FileName|Invalid filename" Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Label ID="lblfilepath" runat="server" Font-Names="Calibri" 
                                        Font-Size="Small" Text="Descrption:"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtdescription" runat="server" Width="204px" 
                                        Wrap="False" ValidationGroup="description|Invalid description"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:TextBox ID="txtfilename0" runat="server" 
