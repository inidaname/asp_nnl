<%@ Page Title="Invoice" Language="VB" MasterPageFile="~/companynoheader.master" AutoEventWireup="false" enableEventValidation="false"  CodeFile="invioces.aspx.vb" Inherits="invioces"  %>
...
<div id="item1"  runat ="server">
      ...
      <div class="item_title">&nbsp;&nbsp;&nbsp; Invioces(<asp:Label ID="lblMsg" 
              runat="server"></asp:Label> | Amt Selected(<asp:Label 
              ID="lblamtSelected"  Text="0.00"
              runat="server" ForeColor="#CC0000"></asp:Label>
          ) </div>
        <center>
        <div>.</div>
 <div id="Div1" runat ="server" style="font-family: Calibri; font-size: small; font-weight: normal" >
     <asp:DropDownList ID="cboQueryOptions" runat="server">
         <asp:ListItem Selected="True">All Payment</asp:ListItem>
         <asp:ListItem>Full Payment</asp:ListItem>
         <asp:ListItem>Outstanding Payment</asp:ListItem>
     </asp:DropDownList>
...
&nbsp;<asp:CheckBox ID="chkIncludeDate" runat="server" Text="Include Date" />
 ...
 <hr />
  <div align="left">
      ...
      <asp:Button ID="btnSearch0" runat="server" PostBackUrl="~/inviocesreports.aspx" 
          Text="INVOICE REPORTS" />
 </div>
 <div>
    <asp:Button ID="btnSearch" runat="server" Text="Search Invioce" />
 </div>
                  ...
                  <div>
                      <table style="width: 100%;">
                          ...
                          <tr>
                              ...
                              <td align="center">
                                  <asp:Button ID="btnPayAll0" runat="server" Text="Pay Selected" />
                                  <asp:Button ID="btnPayAll" runat="server" Text="Pay All" />
                                  &nbsp;
                              </td>
                              <td>
                                  &nbsp;
