<%@ Page Language="VB" AutoEventWireup="false"  MasterPageFile="~/exportpage.master" CodeFile="Copy of exportpermit.aspx.vb" Inherits="exportpermit" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cboUC" runat="server" ToolTip="select Ultimate Consigee" 
                                        ValidationGroup="UCID" Width="204px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtamtPerBarrel" runat="server" BorderColor="#CCCCCC" 
                                          ValidationGroup="amtPerBarrelUS" 
                                        Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtAmtUS" runat="server" BorderColor="#CCCCCC" 
                                        BorderStyle="Solid" ValidationGroup="TotalamtUS" Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:TextBox ID="txtpassportname" runat="server" 
                                        ValidationGroup="CoverLetterName" Visible="False" Width="20px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td class="style10" style="width: 149px">
                                    <asp:Label ID="Label36" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Upload Permit Application Cover Letter" Visible="true"></asp:Label>
                                </td>
                                <td colspan="4">
                                    <cc1:AsyncFileUpload ID="fileStuPicture" runat="server" Width="200px" 
                                        ClientIDMode="AutoID"    />
