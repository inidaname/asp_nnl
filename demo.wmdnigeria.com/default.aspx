<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default" %>
...
<body>
    ...
    <div class="content">
         <asp:Panel ID="DepositPanel" runat ="server" CssClass ="content-container"  style="margin-top:-20px;margin-left:-0px;padding:0px;width:100%;">

            <div class="title-bar">
                   <span class ="left">Welcome to Weights & Measures Department of Federal Ministry of Industry, Trade and Investment </span>
                    <asp:Label ID="WelcomeMessage" runat="server" style="float:right;margin-right:30px;text-transform:capitalize" Text=""></asp:Label>
            </div>
            </asp:Panel>
        ...
        <div class="login-section">
            ...
            <asp:Panel ID="LoginPanel"  class="login" runat="server">
                <div>
                    <h3 style="color:#0C4C70">Login</h3>
            ...
            <asp:Panel ID="PasswordResetPanel" Visible ="false"  class="login" runat="server">
                <div>
                    <h3 style="color:darkred;margin-bottom:30px;">Reset Password</h3>
                        <asp:Label runat="server"  style="font-weight:bolder;margin-left:15px;margin-bottom:15px;font-size :13px" ID="EmailLabel">E-mail Address:</asp:Label>
                        <asp:TextBox ID="AccountEmail" runat="server" placeholder="Enter registered email" style="margin-top:10px" cssclass="input" ></asp:TextBox>
                        
                        
                        <asp:label runat="server" style="font-weight:bolder;margin-left:15px;font-size :13px" Visible="false" ID="PasswordResetReqeustCode" Text ="Password Reset Request Code:" ToolTip ="Enter Code sent to your Mobile!"></asp:label>
                        <asp:TextBox ID="PasswordResetCode" Visible="false" MaxLength ="6" style="margin-top:10px;background :rgb(255,255,255);padding-left:10px;" runat="server" placeholder="Enter Code sent to your mobile" cssclass="input" ></asp:TextBox>
                        ...
                        <asp:TextBox ID="NewPassword" Visible="false"  runat="server" TextMode="Password" placeholder="***************"  CssClass ="input-password"></asp:TextBox>
                         ...
                         <p><asp:Label runat="server" style="font-weight:bolder;margin-left:15px;float:left;line-height:25px;font-size:13px" Visible="false"  ID="ConfirmPasswordLabel">Confirm Password:</asp:Label></p>
                        ...
                        <div class="login-button">
                         <asp:Button ID="ContinueReset" Visible="false" runat="server" class="button" Text="Verify Code" />
                         ...
                         <asp:Button ID="ResendPasswordResetCode" UseSubmitBehavior="false" runat="server" Visible="false" BackColor="Transparent" BorderColor="Transparent" ForeColor="SteelBlue" Font-Bold="true" style="cursor:pointer;margin-left:20px;margin-top:15px;" Text="Resend Password Reset Code" /><br />
                         <asp:Label ID="ErrorMessage" runat="server" Visible="false" BackColor="Transparent" BorderColor="Transparent" ForeColor="Red" style="width:90%;font-size:11px;margin:2px auto;line-height:none;" Text="" />
         ...
         <div class="inner-box">
             ...
             <div class="news-section-divider"> 
                 ...
                 <div class="news-wrapper">
                    ...
                    <a id="A4" runat ="server" title ="Read Full News" href='<%# String.Format("../article/news-reader/?ArticleID={0}", ArticleID1())%>'><div class="read-more">Read More</div></a>
                 </div>
             </div>
           ...
           <div class="news-section-divider"> 
                 ...
                 <div class="news-pix"> <div class="news-image" style= '<% Response.Write("background:url(images/article/" + ImageName2() + ") no-repeat rgb(255,255,255);background-size:cover;")%>'></div></div>
                  <div class="news-wrapper">
                    ...
                    <a id="A3" runat ="server" title ="Read Full News" href='<%# String.Format("../article/news-reader/?ArticleID={0}", ArticleID2())%>'><div class="read-more">Read More</div></a>
                 </div>
             </div>
            ...
            <div class="news-section-divider"> 
                 ...
                 <div class="news-wrapper">
                    ...
                    <a id="A2" runat ="server" title ="Read Full News" href='<%# String.Format("../article/news-reader/?ArticleID={0}", ArticleID3())%>'><div class="read-more">Read More</div></a>
                 </div>
             </div>
            ...
            <div class="news-section-divider"> 
                 ...
                 <div class="news-wrapper">
                    ...
                    <a id="A1" runat ="server" title ="Read Full News" href='<%# String.Format("../article/news-reader/?ArticleID={0}", ArticleID4())%>'><div class="read-more">Read More</div></a>
                 </div>
             </div>
    ...
    <div class="vission-mission-section">
        <div class="vission-mission-inner-box">
            <div class="title">Vision & Mission Statement</div>
            
        
            <div class="vission-mission-divider">
                <h5>Mission Statement</h5>
                <p>To formulate and implement policies and programmes to attract investment, boost industrialization, increase trade and exports and develop eenterprises</p>
            </div>

            <div class="vission-mission-divider">
                <h5>Vision Statement</h5>
                <p>To promote economic growth, create jobs and generate wealth</p>
            </div>
...
Legal Metrology provides regulations for the control of the measurements and mearuring instruments. Legal metrology also provides protection of public safety.</p>
    ...
    <div class="copyright">
        <div class="copy">
            <div class="copyright-text">Copyright &copy; 2013 - <%# String.Format("{0}", Today.Year )%>. All rights reserved. Powered by <a href="http://www.nnlnigeria.com" target="_blank" style="color:rgb(12, 76, 112);">Nigerco Nigeria Ltd.</a></div>
            <div class="social">
