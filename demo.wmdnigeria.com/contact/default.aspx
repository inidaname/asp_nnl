        ...
        <div class="header">
            ...
            <div class="half-down"> 
                    ...
                    <ul>
                        ...
                        <li  class="active"><a href="./"><span>CONTACT US</span></a>
                            <ul style="right:10px;text-align:right;">
                              <li><a href="wmd/">Weights & Measures</a></li>
                              <li><a href="cpi/">CPI Department</a></li>
                              <li><a href="nigerco/">Nigerco Nigeria Ltd.</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
              ...
              <asp:Panel ID="ToolBar" runat ="server"  class="tools-bar">
                <div class="inner">
                    <asp:button ID="InvoiceIcon" UseSubmitBehavior ="false"  runat ="server" style="background:url(../images/invoice.png) no-repeat 0px 10px scroll; background-size :20px 20px; "  class="icon" Text ="Billing" />
                    <asp:button ID="DepositIcon" UseSubmitBehavior ="false" runat ="server" style="background:url(../images/deposit.png) no-repeat 0px 10px scroll; background-size :20px 20px; " class="icon" Text ="e-Wallet" />
                    ...
                    <asp:button ID="InstrumentServicesicon" UseSubmitBehavior ="false" runat ="server" style="background:url(../images/instruments.png) no-repeat 0px 10px scroll; background-size :20px 20px; " class="icon" Text ="Instrument Certification" />
