<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default26" %>
...
<head id="Head1" runat="server">
    <title>Weight & Measures : CPI Contact</title>
...
<body>
    ...
    <div class="content">
            ...
            <div class="title">Commodity & Products Inspectorate Department</div>
            ...
            <div class="contact-details">
                ...
                <p>Contact Person:</p> 
                <span>Ofonba Ehikede</span>


                <p>Email Address:</p>
                <span>ofonbas@yahoo.com</span>
                <p>Phone Number:</p>
                +234 (0) 802 390 7820 
