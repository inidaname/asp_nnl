    ...
    <header>
        ...
        <div class="overall-container">
            <div class="sidebar">
                <nav>
                    <ul>
                        ...
                        <asp:Panel ID="CompanyManagementLink" runat="server" CssClass ="PanelDiv"><li class="active" style="background-image:url(../../../images/management.png) ;background-repeat:no-repeat; background-position: 10px 10px; background-size:30px 30px; "><a href="./"><span>Transaction Approval</span></a></li> </asp:Panel>
            ...
            <div class="dashboard-container">
                ...
                <div class ="dashboard-title">Transaction Approval</div>


                <div class="dashboard-icon-container"> 
                            <div class="dashboard-icon-container-title">
                                <span style="float:left;margin-right:30px"><strong>Type: </strong></span>
