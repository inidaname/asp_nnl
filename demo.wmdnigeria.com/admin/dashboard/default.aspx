...
<head id="Head1" runat="server">
 ...
 <body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="CreateUserUpdatePanel">
        <ProgressTemplate>
        ...
        <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="ModifyUserUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress3" runat="server" AssociatedUpdatePanelID="LogUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress4" runat="server" AssociatedUpdatePanelID="BackLogUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress5" runat="server" AssociatedUpdatePanelID="LotsUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress6" runat="server" AssociatedUpdatePanelID="LotTableUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress7" runat="server" AssociatedUpdatePanelID="DownloadUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress8" runat="server" AssociatedUpdatePanelID="NewsUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress9" runat="server" AssociatedUpdatePanelID="GalleryUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress10" runat="server" AssociatedUpdatePanelID="OfficeSetupUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress11" runat="server" AssociatedUpdatePanelID="QuizUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress12" runat="server" AssociatedUpdatePanelID="CareerUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress13" runat="server" AssociatedUpdatePanelID="UploadInstrumentUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress14" runat="server" AssociatedUpdatePanelID="MeasurementUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress15" runat="server" AssociatedUpdatePanelID="StatesUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress16" runat="server" AssociatedUpdatePanelID="UpdatePanelFee">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress17" runat="server" AssociatedUpdatePanelID="DataFeeUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress18" runat="server" AssociatedUpdatePanelID="DataFeeUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress19" runat="server" AssociatedUpdatePanelID="UpdatePanelInstrument">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress20" runat="server" AssociatedUpdatePanelID="CompanyAccountUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress21" runat="server" AssociatedUpdatePanelID="SendMailUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress22" runat="server" AssociatedUpdatePanelID="SMSAPIUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress23" runat="server" AssociatedUpdatePanelID="SendSMSUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
        ...
        <asp:UpdateProgress ID="UpdateProgress24" runat="server" AssociatedUpdatePanelID="SMSAPIUpdatePanel">
        <ProgressTemplate>
            <div class="loading-progress">
                <div class="center"></div>
            </div>
            ...
            <div class="dashboard-container">
                ...
                <div class="dashboard-icon-container"> <div class="dashboard-icon-container-title"><span><strong>System Setup / Configuration: </strong>Manage admin and staff users - Create new user, modify user, Grant roles to user, </span></div> 
                    ...
                    <asp:Panel ID="LotTable" runat="server"><a href="#lot-table"><div class ="icon-wrapper">
                        <div class ="icon-image"  style="background:url(../../../images/table.png) no-repeat; background-size:cover;"></div>
                         <div class ="icon-title">Terminal Lot</div>
                         <div class ="icon-brief">Create new admin user with user role</div>
                    ...
                    <asp:Panel ID="LotsAllocation" runat="server"><a href="#lots-allocation"><div class ="icon-wrapper">
                        <div class ="icon-image"  style="background:url(../../../images/allocation.png) no-repeat; background-size:cover;"></div>
                         <div class ="icon-title">Terminal Allocation</div>
                    ...
                    <asp:Panel ID="setupOffice" runat="server"><a href="#setup-office"><div class ="icon-wrapper">
                        <div class ="icon-image"  style="background:url(../../../images/office.png) no-repeat; background-size:cover;"></div>
                         <div class ="icon-title">WMD Offices</div>
                         <div class ="icon-brief">Create new admin user with user role</div>
                ...
                <div class="dashboard-icon-container"> <div class="dashboard-icon-container-title"><span><strong>Settings: </strong>Manage communication, notification, security settings for the system and manage user accounts</span></div> 
                    ...
                    <div class="modal" id="create-user" aria-hidden="true">
                        ...
                        <asp:UpdatePanel ID="CreateUserUpdatePanel" ChildrenAsTriggers="false" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                        ...
                        <div class="form-container">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="AccountType" runat="server" AutoPostBack="true" OnSelectedIndexChanged ="AccountType_SelectedIndexChanged" CssClass="select">
                                    ...
                                    <asp:ListItem Text="Minister Account" Value="Minister"></asp:ListItem>
                    ...
                    <div class="modal" id="modify-user" aria-hidden="true">
                        <asp:UpdatePanel ID="ModifyUserUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                      <div class="modal-dialog" style="width:700px; top: 2%;">
                        <div class="modal-header">
                    ...
                    <div class="modal" id="user-logs" aria-hidden="true">
                        <asp:UpdatePanel ID="LogUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:1050px; height:610px;padding:0px; top: 2%;left:38%;">
                    ...
                    <div class="modal" id="back-logs" aria-hidden="true">
                        <asp:UpdatePanel ID="BackLogUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                            ...
                            <div class="modal-body" >
                                ...
                                <div class="form-container">
                                     <iframe id="Iframe1" src ="https://demo.wmdnigeria.com/admin/php/?Session=ActiveFromAdmin"  runat="server" class="iframe" style="width:100%;height:470px;"></iframe>
                    ...
                    <div class="modal" id="lots-allocation" aria-hidden="true">
                        <asp:UpdatePanel ID="LotsUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="lot-table" aria-hidden="true">
                        <asp:UpdatePanel ID="LotTableUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="download-center" aria-hidden="true">
                        <asp:UpdatePanel ID="DownloadUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="upload-news" aria-hidden="true">
                        <asp:UpdatePanel ID="NewsUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                    ...
                    <div class="modal" id="upload-picture" aria-hidden="true">
                        <asp:UpdatePanel ID="GalleryUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="setup-office" aria-hidden="true">
                        <asp:UpdatePanel ID="OfficeSetupUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="upload-quiz" aria-hidden="true">
                        <asp:UpdatePanel ID="QuizUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="upload-career" aria-hidden="true">
                        <asp:UpdatePanel ID="CareerUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="instrument-fee" aria-hidden="true">
                        <asp:UpdatePanel ID="UploadInstrumentUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="Measurement" aria-hidden="true">
                        <asp:UpdatePanel ID="MeasurementUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="upload-states" aria-hidden="true">
                        <asp:UpdatePanel ID="StatesUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="fee-group-sub" aria-hidden="true">
                        <asp:UpdatePanel ID="UpdatePanelFee" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="fee-section" aria-hidden="true">
                        <asp:UpdatePanel ID="DataFeeUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="upload-instrument" aria-hidden="true">
                        <asp:UpdatePanel ID="UpdatePanelInstrument" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;">
                            <div class="modal-header">
                            ...
                            <div class="modal-body" >
                                ...
                                <div class="form-container" style="float:left; margin-left:15px;height:110px;">
                                 
                                         <h3 style="margin-bottom:-5px; height:20px;">SECTOR SECTION</h3>
                                ...
                                <div class="form-container" style="float:left;margin-left:15px;margin-top:-10px;height:190px;">
                                 
                                         <h3 style="margin-bottom:-5px;height:20px;">INSTRUMENT CATEGORY SECTION</h3>
                                ...
                                <div class="form-container" style="float:left;margin-left:15px;margin-top:-10px;">
                                    <h3 style="margin-bottom:-5px;height:20px;">INSTRUMENT SUB CATEGORY SECTOIN</h3>
                    ...
                    <div class="modal" id="password-recovery" aria-hidden="true">
                        <asp:UpdatePanel ID="CompanyAccountUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="compose-email" aria-hidden="true">
                        <asp:UpdatePanel ID="SendMailUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="api-configuration" aria-hidden="true">
                        <asp:UpdatePanel ID="SMSAPIUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
                    ...
                    <div class="modal" id="send-messages" aria-hidden="true">
                        <asp:UpdatePanel ID="SendSMSUpdatePanel" runat="server" EnableViewState ="true"  >
                        <ContentTemplate>
                          <div class="modal-dialog" style="width:700px; top: 2%;"">
                            <div class="modal-header">
