...
Public Class _default7
    ...
    Dim TodaysDate = Date.Today.ToString("dd-MM-yyyy")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Response.AppendHeader("Refresh", "300;url=./")
            ...
            Using cn As MySqlCommand = New MySqlCommand(db, conn)
                Using da As New MySqlDataAdapter(cn)
                    ...
                    For Each Row As DataRow In ds.Tables(0).Rows
                        ...
                        MessageBox.Show(Me, "Hey man" & DateDifference)
        ...
        Catch ex As Exception
            MessageBox.Show(Me, DateDifference)
    ...
    Public Sub GetExpiredInstrument()
        Try
            ...
            Dim Purpose = "Annual Licensing Renewal Fee" & Session("InstrumentName") & " with Serial Number:" & Session("InstrumentSerialNumber")
            Dim Narration = "Annual Licensing Renewal Bill for " & Session("InstrumentName") & " with Serial Number:" & Session("InstrumentSerialNumber")
            Dim PaymentFor = "Annual Licensing Renewal Invoice"
