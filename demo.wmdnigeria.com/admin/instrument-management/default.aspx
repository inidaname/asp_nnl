    ...
    <header>
        ...
        <div class="overall-container">
            <div class="sidebar">
                <nav>
                    <ul>
                        ...
                        <asp:Panel ID="InstrumentManagementLink" runat="server" CssClass ="PanelDiv"><li class="active" style="background-image:url(../../../images/instrument.png) ;background-repeat:no-repeat; background-position: 10px 10px; background-size:30px 30px; "><a href="./"><span>Instrument History</span></a></li></asp:Panel>
            ...
            <div class="dashboard-container">
                ...
                <div class ="dashboard-title">Instrument History</div>
                ...
                <div class="dashboard-icon-container"> 
                          ...
                          <asp:Panel ID="Panel1" runat ="server" style="margin-bottom:10px">
                                ...
                                <asp:GridView ID="RegisteredInstrumentGridView" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="8" CssClass="grid" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr"  OnSelectedIndexChanged="OnInstrumentSelectedIndexChanged" >        
                                 <Columns>
                                     <asp:BoundField DataField="deviceType" ItemStyle-wrap="true" ItemStyle-Width ="110px" HeaderStyle-Width ="110px" HeaderText="Instrument" />
