<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default35" %>
...
<body>
    ...
    <asp:Panel ID="HeaderPanel" runat ="server"  CssClass ="headers">
        ...
        <div class="header">
           ...
           <%--           
            <asp:Panel ID="Panel1" runat ="server"  class="tools-bar">
                <nav>
                    <ul class="inner" style="margin-top:-2px;">
                        <li><asp:button ID="Button1" UseSubmitBehavior ="false"  runat ="server" style="background:url(../../images/inspection.png) no-repeat 5px 10px scroll; background-size :20px 20px; " class="icon" Text ="Inspection" /></li>
                        <li><asp:button ID="Button2" UseSubmitBehavior ="false" runat ="server" style="background:url(../../images/verification.png) no-repeat 5px 10px scroll; background-size :20px 20px; " class="icon" Text ="Verification Bill" /></li>
                        <li><asp:button ID="Button3" UseSubmitBehavior ="false" runat ="server" style="background:url(../../images/enforcement.png) no-repeat 5px 10px scroll; background-size :20px 20px; " class="icon" Text ="Enforcement" /></li>
                        <li class="active"><asp:button ID="Button4" UseSubmitBehavior ="false" runat ="server" style="background:url(../../images/instruments.png) no-repeat 5px 10px scroll rgb(200,200,200); background-size :20px 20px; " class="icon" Text ="Instruments" /> </li>
    ...
    <div class="content">
        <asp:Panel ID="DepositPanel" runat ="server" CssClass ="content-container"  style="background:rgb(245,245,245)">

           
            <div class="title-bar">
                   <span class ="left"><asp:Label runat="server" ID="ArticleHeading" Text="KNOW WHAT IS HAPPENING IN THE WEIGHTS AND MEASURES DEPARTMENT OF THE FEDERAL MINISTRY OF INDUSTRY, TRADE AND INVESTMENT"></asp:Label></span>
 
            </div>


            
            <div class ="general-form" style="margin:0px;padding:0px;width:100%;margin-bottom:30px;background:rgb(245,245,245);">
                <div class="news-sidebar">
                    <div class="category-block">
                        <asp:Repeater ID="GetAllNewsGroup" runat="server">
                            <ItemTemplate>
                                <a href='<%# String.Format("../?article-category={0}", Eval("articleGroup"))%>'>
                                    <div class="link"><%# Eval("articleGroup")%></div>
        	                    </a>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
                ...
                <div class="news-frame">
                    <div class="news-preview-container" >
                        ...
                        <asp:Repeater ID="GetNewsInDetail" runat="server">
                        <ItemTemplate>
                            <a class="news-preview-container" href='<%# String.Format("news-reader/?article-id={0}", Eval("ID"))%>'>
                                <div class="news-preview-container" >
                                    
                                    <div class="news-title"><%# Eval("articleTitle")%></div>
                                    <div>
                                        <img src='<%# String.Format("../../images/article/{0}", Eval("imageLink"))%>' style="margin-right:10px;height:200px;width:200px;"/>
                                        <span class="news"><%# Eval("article")%></span>
                                    </div>
