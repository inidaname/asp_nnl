<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default44" %>
...
<body>
            ...
            <asp:Panel ID="WMDInspectorTools" runat ="server"  class="tools-bar">
                <nav>
                    <ul class="inner" style="margin-top:-2px;">
                        ...
                        <li class="active"><asp:button ID="Enforcement" UseSubmitBehavior ="false" runat ="server" style="background:url(../../images/enforcement.png) no-repeat 5px 10px scroll rgb(200,200,200); background-size :20px 20px; " class="icon" Text ="Enforcement" /></li>
    ...
    <div class="content">
        <asp:Panel ID="DepositPanel" runat ="server" CssClass ="content-container">
            ...
            <div class="title-bar">
                   <span class ="left">Enforcement Worksheet <asp:Label ID="AlbumTitle" runat="server" ></asp:Label></span>
            ...
            <div class ="general-form" style="margin-bottom:50px;" >
                ...
                <div class="form-group">
                        <label for="ExportQuarter" >Company Name:</label>
                ...
                <div class="form-group" >
                 ...
                 <div class="form-group" >
                    <label>Enforcement Date:</label>
                    <asp:TextBox ID="EnforcementDate" runat ="server" CssClass ="input"></asp:TextBox>
                 </div>
                
               
                <div class="form-group" >
                    <label>Upload Worksheet:</label>
                    <asp:FileUpload ID="EnforcementWorkSheet" runat ="server" CssClass ="input"></asp:FileUpload>
                </div>
                ...
                <div class="form-group" style="float:right;width:30%;display:inline-block ; padding-top:10px;">
                    <asp:Button ID="CancelEnforcement" runat ="server" UseSubmitBehavior="false" CssClass ="pay-button" Text ="Cancel"  />
                    <asp:Button ID="UploadEnforcement" runat ="server" CssClass ="pay-button" Text ="Upload" UseSubmitBehavior ="true"  />
            ...
            <asp:Panel ID="InvoiceViewPanel" runat ="server" style="margin-bottom:10px">
                <asp:GridView ID="RegisteredInstrumentGridView" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="15" OnPageIndexChanging="RegisteredInstrumentGridView_PageIndexChanging" CssClass="grid" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr"  OnSelectedIndexChanged ="ViewDownloadWorksheet" >        
                    <Columns>
                        ...
                        <asp:BoundField DataField="enforcedBy" ItemStyle-wrap="true" ItemStyle-Width ="250px" HeaderStyle-Width ="250px"  HeaderText="Submitted By" />       
                        <asp:BoundField DataField="enforcementDate" ItemStyle-wrap="true" HeaderText="Date" />       
                        <asp:BoundField DataField="enforcementSheet" ItemStyle-wrap="true" HeaderText="Worksheet" HeaderStyle-Width ="300px" ItemStyle-Width="300px"/>       
                        <asp:ButtonField Text="Download" ItemStyle-ForeColor="GrayText" HeaderText ="Action" CommandName="Select" />       
                    </Columns>
