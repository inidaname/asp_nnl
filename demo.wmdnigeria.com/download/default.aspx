<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default2" %>
...
<head id="Head1" runat="server">
    <title>Weight & Measures : Downloads</title>
...
<body>
    ...
    <div class="content" style="height:200px">
        ...
        <div class="center-container-section"> 
            ...
            <asp:Linkbutton Visible="false" ID="DownloadWrapper" runat="server" class="download-wrapper">
                <asp:Panel ID="DownloadWrapperCovers" runat="server" class="download-wrapper-cover">Download</asp:Panel>
                <asp:Image ID="DownloadDocPreviews" runat="server" class="download-doc-preview" ></asp:Image>
                <asp:Panel ID="DownloadDocNamesPanel" runat="server" class="download-doc-name" ><asp:Label runat ="server" ID="DownloadDocName" text=" This is A Document"></asp:Label></asp:Panel>
            </asp:Linkbutton>

            <div style="width:100%;margin:0 auto; font-size:20px;font-weight:bolder;margin-top:30px;color:#000;text-align:center;">No file is available for download, check back later!</div>
