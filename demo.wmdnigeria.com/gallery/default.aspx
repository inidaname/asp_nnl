<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default24" %>
...
<body>
    ...
    <div class="content">
        <asp:Panel ID="DepositPanel" runat ="server" CssClass ="content-container">
            ...
            <div class="title-bar">
                   <span class ="left">PHOTO GALLERY</span>
            ...
            <div class ="general-form"  >
                <asp:Panel ID="PhotoGalleryAlbums" runat ="server" style="margin-bottom:10px">
                    <asp:Repeater ID="PhotoAlbum" runat="server">
                            <ItemTemplate>
                                <a href='<%# String.Format("album-photo/?photo-album={0}", Eval("groups"))%>'>
                                    <div class="photo-album" onclick="toggle_visibility('<%# String.Format("{0}", Eval("groups"))%>');" style="background:url(../images/gallery/album.png);background-size:cover;" title="Click to View Album Photos">
                                    <div class="title"><%# String.Format("{0}", Eval("groups"))%></div>
                                    </div>
                                </a>
                            </ItemTemplate>
                        </asp:Repeater>
                ...
                <asp:Panel ID="General" runat ="server" style="margin-bottom:10px">
                    ...
                    <asp:Panel ID="NoRecord" runat="server" class="no-record"><span>No album to display in Gallery!</span></asp:Panel>
