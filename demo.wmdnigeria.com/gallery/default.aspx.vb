...
Public Class _default24
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ConnectDatabase()
            Dim dbg As String = "SELECT * FROM gallerygroups"
            Using cn As MySqlCommand = New MySqlCommand(dbg, conn)
                Using da As New MySqlDataAdapter(cn)
                    ...
                    Else
                        NoRecord.Visible = False
                    End If
                    PhotoAlbum.DataSource = dt
                    PhotoAlbum.DataBind()
                End Using
            End Using

            'This display photos under each album
            Dim db As String = "SELECT * FROM gallery LIMIT 8"
    ...
    Protected Sub DisplayAlbumPhotos(ByVal sender As Object, ByVal e As System.EventArgs)
