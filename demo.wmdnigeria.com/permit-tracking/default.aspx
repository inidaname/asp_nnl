<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default25" %>
...
<body>
            ...
            <div class="half-down"> 
                ...
                <nav>
                    <ul>
                        ...
                        <li class="active"><a href="../permit-tracking"><span>PERMIT TRACKING</span></a></li>
    ...
    <div class="content">
        <asp:Panel ID="DepositPanel" runat ="server" CssClass ="content-container">
            ...
            <div class="title-bar">
                   <span class ="left">For tracing and tracking of issued export permit for: Pre-shipment, Customs and International Trade.</span>
            ...
            <div class ="general-form"  >
                 ...
                 <div class="form-group" style="width:80%;margin:0 auto;margin-top:50px;margin-left:70px;">
                     <label style="vertical-align:middle;display:inline-block;float:left;height:15px;width:200px;padding-top:8px;">Export Permit Number:</label>
                    <asp:TextBox ID="ExportPermitReferenceNumber"  style="width:50%;height:28px;display:inline-block;" runat="server" CssClass="input" placeholder="Export Permit Reference Number"></asp:TextBox>
                    <asp:Button ID="TrackExportPermit" runat="server" CssClass ="pay-button" style="margin-top:0px;margin-right:0px;" Text="Track Permit" />   
                     <asp:Label runat="server" ID="ReturnMessage" Text="" style="width:100%;float:left;text-align:center;height:auto;margin-bottom:30px;margin-top:30px;"></asp:Label>
                 </div>
