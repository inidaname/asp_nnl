<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default28" %>
...
<body>
    ...
    <div class="content">
            ...
            <div class="title">Weights & Measures Department</div>
            ...
            <div class="contact-details">
                ...
                <p>Contact Person:</p> 
                <span>Engr. Sikuade</span>


                <p>Email Address:</p>
                <span>ojsikuade@yahoo.com</span>
                <p>Phone Number:</p>
                +234 (0) 802 303 5449
