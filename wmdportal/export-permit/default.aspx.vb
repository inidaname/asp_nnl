...
Public Class _default15
    ...
    Protected Sub OnInvoiceSelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Using cn As MySqlCommand = New MySqlCommand(db, conn)
                Using da As New MySqlDataAdapter(cn)
                    ...
                    Dim dbc As String = "SELECT * FROM city WHERE ID='" & Session("UserLoginCompanyCity") & "'"
        ...
        Finally
            ...
            Response.AppendHeader("Refresh", "0;url=#continue-application")
        End Try
                        ...
                        Using da As New MySqlDataAdapter(cn)
                            ...
                            Try
                                ...
                                If LastQuarterRegisteredDate = CurrentYear Then
                                    MessageBox.Show(Me, "Intelligence System has detect the Permit Quarter has been applied for, your application is now running in Supliment Mode, Select a different Quarter to Continue: " & CurrentYear & "    " & LastQuarterRegisteredDate)
