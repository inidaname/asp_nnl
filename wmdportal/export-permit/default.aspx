            ...
            <asp:Panel ID="NoRecord" runat="server" class="no-record"><span>No record found!</span></asp:Panel>
                ...
                <asp:GridView ID="ExportPermitGridView" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" CssClass="grid" OnPageIndexChanging ="ExportPermitGridView_PageIndexChanging" OnSelectedIndexChanged = "OnInvoiceSelectedIndexChanged" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" >        
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-wrap="true" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass ="right-align" HeaderStyle-Width="100" ItemStyle-Width="100" HeaderText="Total Amt. ($)" > 
                            <ItemTemplate>
                        ...
                        <asp:ButtonField Text="View Detail" ItemStyle-ForeColor ="DarkGray" HeaderText ="Action" CommandName="Select" HeaderStyle-Width ="70" ItemStyle-Width="70" />
                    </Columns>
                    ...
                    <!-- Modal for User logs -->
                    <div class="modal" id="continue-application" style="background:rgba(0, 0, 0, 0.1)" aria-hidden="true">
                      <div class="modal-dialog" style="width:540px; top:2%;">
                        <div class="modal-header">
                          <h2>Export Permit Application Preview</h2>
                          <a href="#close" class="btn-close" aria-hidden="true">×</a> <!--CHANGED TO "#close"-->
                        </div>
                        <div class="modal-body" >

                            <asp:Panel runat ="server" ID="ExportApplicationDetails" class="export-application-details">
                                 <div style="margin:0 auto;width:80px;height:80px;"><img src="../images/coatofarm.png" /></div>
                                <asp:Panel runat ="server" ID="ExportPermitHeading" class="export-application-details-title" >
                                 FEDERAL REPUBLIC OF NIGERIA  <br />FEDERAL MINISTRY OF INDUSTRY, TRADE & INVESTMENT<br />DEPARTMENT OF COMMODITIES AND PRODUCTS INSPECTORATES <br /><span style="font-size:14px;font-weight:normal">Old Secretariat Complex, Area 1, Garki Abuja, Nigeria</span>
                                ...
                                <asp:Panel runat ="server" ID="Body" class="export-application-details-body" >
                                    ...
                                    <asp:TextBox runat ="server" ID="AppName" Enabled="false" CssClass="label-info"></asp:TextBox><br />
                                    
                                    <asp:TextBox runat ="server" ID="text2" Enabled="false" CssClass="label"  Text="Address of Applicant:"></asp:TextBox>
