...
Partial Class exportpermit
    ...
    Protected Sub btnPreview_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        Try
            ...
            txtusername14.Text = "0"

            If cboUC.SelectedIndex > 0 Then
                cboUC.ValidationGroup = "UCID"
            Else
                cboUC.ValidationGroup = ""
            End If
            ...
            txtpassportname.Text = Session("txtpassportname")
            getChange()
...
"</html>"
    ...
    Sub getChange()
        Try
            ...
            Dim AmInUs As Double = (Val(txtamtPerBarrel.Text) * Val(txtFinalQty.Text)) ' * 0.0004
            'AmInUs = AmInUs + (AmInUs * (100 / 5))

            txtAmtUS.Text = ""
            txtAmtUS.Text = AmInUs.ToString
    ...
    Protected Sub fileStuPicture_Load(sender As Object, e As System.EventArgs) Handles fileStuPicture.UploadedComplete
        Try
            If fileStuPicture.HasFile = True Then
                ...
                Session.Add("txtpassportname", extN)
