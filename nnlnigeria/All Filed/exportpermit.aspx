<%@ Page Language="VB" AutoEventWireup="false"  MasterPageFile="~/exportpage.master" CodeFile="exportpermit.aspx.vb" Inherits="exportpermit" %>
...
<script type="text/javascript">
    ...
    function ontextchange() {
        var e = document.getElementById("<%= cboqtyMeasure.ClientID %>");
        var strUser = e.selectedIndex;
//        var strUser = e.options[e.selectedIndex].value;

        var qty = document.getElementById("<%= txtQuatity.ClientID %>").value;
        if (strUser == 2) {
//            qty = qty * 7.1475121;
//            document.getElementById("<%= txtProducName0.ClientID %>").value = "Amount Per Metric Tons(USD):";
            var label = document.getElementById("<%= Label11.ClientID %>");
            label.innerHTML = "Amount Per Metric Tons(USD):";
        } else {
//            document.getElementById("<%= txtProducName0.ClientID %>").value = "Amount Per Barrel(USD):";
            var label = document.getElementById("<%= Label11.ClientID %>");
            label.innerHTML = "Amount Per Barrel(USD):";
        }

        document.getElementById("<%= txtAmtUS.ClientID %>").value = qty * document.getElementById("<%= txtamtPerBarrel.ClientID %>").value;
         
    }

    function ondropselectindexchange() {
        var e = document.getElementById("<%= cboPCF.ClientID %>");
        var strUser = e.selectedIndex + 2;

          if (strUser <= 12 ){ 
        document.getElementById("<%= cboPCT.ClientID %>").selectedIndex = strUser; 
        }
    else {
        document.getElementById("<%= cboPCT.ClientID %>").selectedIndex = strUser-2; 
          }
...
•	Kindly note the all fields marked with the asterisks sign, is mandatory for submission along with this application.<br /><br />
•	If you have uploaded your “Certificate of Incorporation” and “Company Article and Memorandum of Association”, it is no longer mandatory for you to upload the document time you apply for a permit.<br /><br />
•	You are always required to upload the following document each time you apply for an Export Permit;<br /><br />
•	Current Production/Storage/Sales license issued by DPR<br /><br />
•	Current WMD Certificate of Conformity<br /><br />
•	Original bank statement with committed and explicit statement<br /><br />
	3 Years Tax Clearance<br /><br />
•	Attach current Export Permit Application made to DPR<br /><br />
•	Attach current evidence of payment for Monitoring Fees<br /><br />
Failure to attach all documents would result in an uncompleted application, and hence you cannot proceed with this application.
                      ...
                      <asp:Panel ID="Panel1" runat="server">
                        <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="style10" style="width: 149px">
                                    <asp:Label ID="Label1" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Product Description:"></asp:Label><font style="color:#F00">*</font>
                                </td>
                                <td colspan="2">
                                ...
                                <td>
                                    <asp:DropDownList ID="cboPCF" runat="server"  onChange="ondropselectindexchange();"
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="cboqtyMeasure" runat="server" onChange="ontextchange();" 
                                ...
                                <td>
                                    &nbsp;</td>
                                <td class="style7" colspan="2" style="width: 127px">
                            ...
                            <tr>
                                ...
                                <td class="style10" style="width: 149px">
                                    <asp:Label ID="Label25" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Export Quantity:"></asp:Label><font style="color:#F00">
                                    
                                    *</font>
                                </td>
                                <td colspan="2">
                                    <asp:TextBox ID="txtQuatity" runat="server" onkeyup="ontextchange();" 
                                ...
                                <td class="style7" style="width: 127px" colspan="2">
                                    &nbsp;<asp:Label ID="Label13" runat="server" Font-Names="Calibri" 
                                        Font-Size="Small" Text="Port Of Export:"></asp:Label>
                                    <font style="color:#F00">*</font>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtAmtUS" runat="server" BorderColor="#CCCCCC" 
                                        BorderStyle="Solid" onkeypress="return false;" 
                                        ValidationGroup="TotalamtUS|Invalid Amount" Width="204px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td class="style8" colspan="7" align="center">
                                    <asp:TextBox ID="txtProducName0" runat="server" BackColor="#F1F1F1" 
                                        BorderStyle="None" Font-Names="Calibri" Font-Size="X-Small" Visible="False">Amount Per Barrel(USD):</asp:TextBox>
                                    <asp:TextBox ID="txtFinalQty" runat="server" BorderColor="#CCCCCC" 
                                        BorderStyle="Solid" ValidationGroup="finalQuantity" 
...
mso-ansi-language:EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA">Category of Applicant&nbsp; </span>
                                ...
                                <td align="center" colspan="3">
                                    <asp:RadioButton ID="RadioButton4" runat="server" Font-Names="Calibri" 
                                        Font-Size="Small" Text="Non Terminal Operator" 
                            ...
                            <tr>
                                <td colspan="9" align="center" bgcolor="Black">
                                    <font style="color:#F00; font:Calibri;Font-Size:Small; font-weight:bold" >Upload documents accompanying your application.</font></td>
                            </tr>
                            <tr>
                                <td>
                                    &nbsp;</td>
                                ...
                                <td align="left">
                               <a href="#"> <asp:Button ID="btnPopup" ForeColor ="Red"   runat="server" 
                                        Text="Explanatory Note!!" Font-Bold="True" Font-Italic="True" 
                                        Font-Names="Calibri" Font-Size="Small" BackColor="#F1F1F1" 
                                        BorderStyle="None" /> </a>
                                </td>
                                <td>
                                    &nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    &nbsp;</td>
                                <td align="left" class="style10" colspan="6">
                                        <asp:Label ID="CheckBox1" runat="server" 
                                        Font-Names="Calibri" Font-Size="Small" 
                                        Text="Certificate of Incorporation of the applicant's company" 
                                        ValidationGroup="CertificateOfIncor" />
                                </td>
                                <td align="left">
                                    <asp:FileUpload ID="fileLetterPicture1" runat="server" Visible="true" ClientIDMode="AutoID" />
                            ...
                            <tr>
                                ...
                                <td align="left" class="style10" colspan="6" style="height: 25px;">
                                    ...
                                    <asp:Label ID="CheckBox2" runat="server" 
                                        ...
                                        ValidationGroup="CompanyArticleMemo" />
                                </td>
                                <td align="left" style="height: 25px">
                                    <asp:FileUpload ID="fileLetterPicture2" runat="server" Visible="true" ClientIDMode="AutoID" />
                                </td>
                                <td style="height: 25px">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" class="style10" colspan="6">
                                    <asp:Label ID="CheckBox3" runat="server" 
                                        ...
                                        ValidationGroup="LicenseByDPR" />
                                </td>
                                <td align="left">
                                     <asp:FileUpload ID="fileLetterPicture3" runat="server" Visible="true" ClientIDMode="AutoID" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" class="style10" colspan="6"> 
                                    <asp:Label ID="CheckBox4" runat="server" 
                                        ...
                                        ValidationGroup="WeightMeters" />
                                </td>
                                <td align="left">
                                     <asp:FileUpload ID="fileLetterPicture4" runat="server" Visible="true" ClientIDMode="AutoID" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" class="style10" colspan="6"> 
                                    <asp:Label ID="CheckBox5" runat="server" 
                                        ...
                                        ValidationGroup="OriginalBank" />
                                </td>
                                <td align="left">
                                   <asp:FileUpload ID="fileLetterPicture5" runat="server" Visible="true" ClientIDMode="AutoID" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" class="style10" colspan="6"> 
                                    <asp:Label ID="CheckBox6" runat="server" 
                                        ...
                                        ValidationGroup="TaxClearance" />
                                </td>
                                <td align="left">
                                    <asp:FileUpload ID="fileLetterPicture6" runat="server" Visible="true" ClientIDMode="AutoID" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                <td>
                                    &nbsp;</td>
                                <td align="left" class="style10" colspan="6"> 
                                    <asp:Label ID="CheckBox7" runat="server" 
                                        Font-Names="Calibri" Font-Size="Small" 
                                        Text="Attach Export Permit Application Document made to DPR" 
                                        ValidationGroup="DPRApplication" /> 
                                </td>
                                <td align="left">
                                    <asp:FileUpload ID="fileLetterPicture7" runat="server" ClientIDMode="AutoID" 
                                        Visible="true" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td align="left" class="style10" colspan="6" style="height: 25px"><font style="color:#F00"><asp:Label ID="lbl8" runat="server" Text="*"></asp:Label></font>
                                    <asp:Label ID="CheckBox8" runat="server" 
                                        Font-Names="Calibri" Font-Size="Small" 
                                        Text="Attach Evidence of Payment of Monitoring Fees" 
                                        ValidationGroup="EvidenceOfMonitoringFees" />
                                </td>
                                <td align="left" style="height: 25px">
                                    <asp:FileUpload ID="fileLetterPicture8" runat="server" ClientIDMode="AutoID" 
                                        Visible="true" />
                                </td>
                                <td style="height: 25px">
                                    </td>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Button ID="btnUpload" runat="server" Font-Bold="False" Font-Names="Calibri" 
                                        Font-Size="Small" Text="UPLOAD" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="style10" style="width: 149px">
                                    <asp:Label ID="Label20" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Title:"></asp:Label><font style="color:#F00">*</font>
                                </td>
                                <td colspan="2">
                                ...
                                <td class="style7" style="width: 127px" colspan="2">
                                    <asp:Label ID="Label21" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Fullname:"></asp:Label><font style="color:#F00">*</font>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="style10" style="width: 149px">
                                    <asp:Label ID="Label35" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Text="Email Address:"></asp:Label><font style="color:#F00">*</font>
                                </td>
                                <td colspan="2">
                            ...
                            <tr>
                                ...
                                <td colspan="7">
                                    ...
                                    <asp:CheckBox ID="chkDeclare" runat="server" Text =" We declare that the making of any false statement or concealment of any 
