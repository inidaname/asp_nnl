<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/companynoheader.master" CodeFile="bulkregisterdevice.aspx.vb" Inherits="registerdevice" %>
                    ...
                    <asp:Panel ID="Panel2" runat="server">
                       <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="style22">
                                    &nbsp;</td>
                                <td class="style40" style="width: 90px">
                                    &nbsp;</td>
                                <td>
                                    ...
                                    <asp:TextBox ID="txtAccountID" runat="server" ValidationGroup="AccountID|" 
                                        Visible="False" Width="64px"></asp:TextBox>
                                    <asp:TextBox ID="txtTransCode" runat="server" Height="16px" Visible="False" 
                            ...
                            <tr>
                                ...
                                <td class="style39" style="width: 113px">
                                    &nbsp;</td>
                                <td align="center" class="style41" colspan="3">
                                    
                                    <cc1:AsyncFileUpload ID="fileStuPicture" runat="server" Width="90%" 
                                        ClientIDMode="AutoID" /><asp:Button ID="btnExtractData" runat="server" style="height: 26px" 
                                        Text="Extract Data" />
                                    &nbsp;</td>
                                <td>
                                    &nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    &nbsp;</td>
                                <td class="style39" align="center" colspan="5">
                                <hr />
                                <div style="width:100%; float:center">
                                    <asp:GridView ID="grd0" runat="server" Font-Names="Calibri" Font-Size="Small" 
                                        Width="100%">
                                        <Columns>
                            ...
                            <tr>
                                ...
                                <td class="style22">
                                    &nbsp;</td>
                                <td align="left" class="style40" style="width: 90px">
                     ...
                     <%  If RadioButton2.Checked = True Then%>
                            ...
                            <tr>
                                ...
                                <td class="style22">
                                    &nbsp;</td>
                                <td align="center" class="style40" style="width: 90px">
                                    &nbsp;</td>
                                <td>
                                    &nbsp;</td>
                                <td>
