<%@ Page Title="FINANCIAL HISTORY" Language="VB" MasterPageFile="~/adminpage.master" AutoEventWireup="false" CodeFile="incomestatistics.aspx.vb" Inherits="incomestatistics" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
  ...
  <table style="width: 100%;">
            <tr>
                ...
                <td>
                    &nbsp;</td>
                <td class="style2" style="width: 329px">
                    &nbsp;</td>
            ...
            <tr>
                ...
                <td class="style2" style="width: 329px">
                    &nbsp;</td>
                <td style="width: 134px">
                    <asp:RadioButton ID="optBySector" runat="server" Font-Names="Calibri" 
                        Font-Size="Small" Text="View By Sector:" Checked="True" GroupName="m1" />
                </td>
                <td>
                    <asp:DropDownList ID="cboBySector" runat="server" AutoPostBack="True" 
            ...
            <tr>
                ...
                <td class="style2" style="width: 329px">
                    &nbsp;</td>
                <td style="width: 134px">
                    <asp:RadioButton ID="optByState" runat="server" Font-Names="Calibri" 
                        Font-Size="Small" Text="View By State:" GroupName="m1" />
                </td>
                <td>
                    <asp:DropDownList ID="cboByState" runat="server" AutoPostBack="True" 
                        Font-Names="Calibri" Font-Size="Small">
                    </asp:DropDownList>
                </td>
                <td>
            ...
            <tr>
                ...
                <td style="width: 134px">
                    &nbsp;</td>
                <td>
                    <asp:Button ID="btnSearch" runat="server" Text="Process" />
                </td>
                <td>
                    &nbsp;</td>
                <td>
