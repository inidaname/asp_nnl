<%@ Page Title="Setup Arhives" Language="VB" MasterPageFile="~/adminpage.master" AutoEventWireup="false" CodeFile="setuparchives.aspx.vb" Inherits="setuparchives" %>
                        ...
                        <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    &nbsp;</td>
                                <td>
                                    <asp:TextBox ID="txtgDesign" runat="server" ValidationGroup="gDesign" 
                                        Visible="False" Width="40px">1</asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
