<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fpassword.aspx.vb" Inherits="exportpermit" %>
                    ...
                    <div class="demo-container">
                        <div class="green">  
                            ...
                            <%
                                ...
                                If pgk = "admin" Then
                                    Response.Write("<li><a href='Default.aspx'>Main Page</a></li>")
                                    Response.Write("<li><a href='Admin.aspx'>Admin Page</a></li>")
                                Else
        ...
        <ContentTemplate>
         ...
         <tr>
             <td class="style1">
                 &nbsp;</td>
             <td align="right" class="style6">
                 <asp:Label ID="Label1" runat="server" Text="Select Security Question:" 
         ...
         <tr>
             <td class="style1">
                 &nbsp;</td>
             <td align="right" class="style6">
                 <asp:Label ID="Label3" runat="server" Text="Asnwer:" Font-Names="Agency FB"></asp:Label>
             </td>
             <td>
                 
                                    <asp:TextBox ID="txtAnswer" runat="server" ToolTip="enter security answer" 
                                        ValidationGroup="username|Invalid Username" 
                     Width="204px"></asp:TextBox>
