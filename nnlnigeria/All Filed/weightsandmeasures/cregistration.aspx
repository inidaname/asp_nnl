<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/companynoheader.master" EnableEventValidation="false"  CodeFile="cregistration.aspx.vb" Inherits="_Default"  %>
                        ...
                        <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td bgcolor="#99A6B4" colspan="5">
                                    <div class="item_title">&nbsp;&nbsp;&nbsp;COMPANY&#39;S LOGIN CREDENTIALS(All Fields Are Required)</div>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtusername7" runat="server" ToolTip="enter telephone number" 
                                        ValidationGroup="telephone|Invalid company Telephone" Width="204px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtcompany0" runat="server" 
                                        ...
                                        ValidationGroup="RCNumber|Invalid company registration number" Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtusername2" runat="server" ToolTip="enter company's P.O.Box" 
                                        ValidationGroup="POBOX|invalid P.O. Box" Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtusername6" runat="server" ToolTip="enter company website" 
                                        ValidationGroup="companywebsite|Invalid company website" Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtusername8" runat="server" 
                                        ...
                                        ValidationGroup="representativeName|Company Reprentative" Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtusername9" runat="server" 
                                        ...
                                        ValidationGroup="mobilephone|Invalid Representative Mobile" Width="204px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="cbosTitle" runat="server" 
                                        ...
                                        ValidationGroup="filledByTitle|Please select title" Width="204px">
                                ...
                                <td>
                                    <asp:TextBox ID="txttelephone" runat="server" ToolTip="enter telephone number" 
                                        ValidationGroup="filledBytelephone|Enter your telephone number" 
                                        Width="204px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtfullname" runat="server" ToolTip="enter your fullname" 
                                        ValidationGroup="filledBy|Invalid fullname" Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtemailaddress" runat="server" 
                                        ...
                                        ValidationGroup="filledByemail|Invalid email address" Width="204px"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
