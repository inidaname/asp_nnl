...
Partial Class ucexport
    ...
    Sub getAllUC()
        Try
            cboUCEdit.Items.Clear()
            cboUCEdit.DataValueField = "sysID"
            cboUCEdit.DataTextField = "UCName"
            cboUCEdit.DataSource = GenTool.DataSetData("select UCName,sysID from exportuc where companyID=" & Val(Session("ID"))).Tables(0)
            cboUCEdit.DataBind()
        Catch ex As Exception
        Finally
            cboUCEdit.Items.Insert(0, "Select Value")
        End Try
    End Sub
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            ...
            If String.IsNullOrEmpty(Session("USCID")) = True Then
    ...
    Private Sub resetform(ByVal setFont As Boolean, Optional ByVal ds As DataSet = Nothing)
        Try
            ...
            For Each ctn In Panel2.Controls
            ...
            If ds IsNot Nothing Then
                Dim fx As String = GenTool.getValueSystem(ds, "countryID|")
                fx = GenTool.getRowItemInds(dsLcountry, "country", "sysID", fx)
                cboCountry.SelectedIndex = GenTool.getddlindexvalue(cboCountry, fx)
    ...
    Protected Sub btnPreview_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        Try
            ...
            Dim sql = "Insert into exportuc(" & FN & ") Values (" & FV & ")"

            If String.IsNullOrEmpty(Session("USCID")) = True Then
                fStatus = True
            Else

                sql = "Update exportuc set " & FUpdate & " where sysID=" & Val(Session("USCID"))
                fStatus = False
    ...
    Private Sub sendmail(Optional ByVal email As String = "")
        Try
            ...
            cBlast.mailbcc = New Net.Mail.MailAddress("operations@wmdnigeria.com")
...
"</html>"
    ...
    Protected Sub cboUCEdit_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboUCEdit.SelectedIndexChanged
        If cboUCEdit.SelectedIndex > 0 Then
            Dim fsql As String = "select * from exportuc where sysID=" & Val(Session("USCID")) & " AND sysID=" & Val(cboUCEdit.SelectedValue)
            Session("USCID") = cboUCEdit.SelectedValue
