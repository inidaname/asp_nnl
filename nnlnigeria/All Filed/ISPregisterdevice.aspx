<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/ISP.master" CodeFile="ISPregisterdevice.aspx.vb" Inherits="ISPregisterdevice" %>
                       ...
                       <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td class="style40" style="width: 129px">
                                    <asp:TextBox ID="txtISPID" runat="server" ValidationGroup="ISPID|" 
                            ...
                            <tr>
                                ...
                                <td class="style39" colspan="5">
                                    <div class="item_title">
                                        &nbsp;&nbsp;&nbsp;INSTRUMENT ANNUAL LICENSING FEE (<asp:Label ID="lblAmount" runat="server"></asp:Label>
                                        )&nbsp;&nbsp;
                                    </div>
                                </td>
                                <td>
