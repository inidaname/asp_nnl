<%@ Page Title="Upload Photo Gallery" Language="VB" MasterPageFile="~/adminpage.master" AutoEventWireup="True" CodeFile="uploadphotogallery.aspx.vb" EnableEventValidation ="false" Inherits="uploadphotogallery"   %>
                        ...
                        <table style="width:100%;" cellspacing="1" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td bgcolor="#99A6B4" colspan="5">
                                    <div class="item_title">&nbsp;&nbsp;&nbsp;PHOTO GALLERY</div>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left" colspan="2">
                                    <asp:DropDownList ID="cboGroupName" runat="server" 
                                        ValidationGroup=" GroupID|Invalid Gallery Group|1" Width="204px">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="5">
                                    <asp:TextBox ID="txtdescription" runat="server" Height="157px" 
                                        TextMode="MultiLine" ValidationGroup="Message|Invalid Message" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtphotosysname" runat="server" ValidationGroup="photosysname" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPhotoName" runat="server" ValidationGroup="PhotoName" 
                                        Visible="False"></asp:TextBox>
                                </td>
                                <td>
                                    &nbsp;</td>
