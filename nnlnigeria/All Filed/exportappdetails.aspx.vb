...
Partial Class exportappdetails
    ...
    Protected Sub btnPreview_Click(sender As Object, e As System.EventArgs) Handles btnPreview.Click
        ...
        Try
            ...
            If GenTool.ExecuteDatabase(Session("exportp")) = True Then
                ...
                Dim sd As String = "Insert into paymentsheet(companyID,amountDue,narration,paymentName,OrderId,TransCode) values(" & _
                Val(Session("ID")) & "," & Val(Request.QueryString("txtAmtUS")) & ",'Export Permit Application'," & GenTool.addbackslash(Session("cname")) & "," & _
    ...
    Private Sub sendmail(Optional ByVal email As String = "")
        Try
            ...
            cBlast.AttarchFiles = ""
            cBlast.BodyM = getBody(streetAddress, City)
    ...
    Private Sub sendmail1(Optional ByVal email As String = "")
        Try
            ...
            Dim cBlast As New MailContents
            cBlast.AttarchFiles = ""
            cBlast.BodyM = getBody1(Session("cname"), Val(Request.QueryString("txtAmtUS")))
            cBlast.IsBodyHtml = True
            cBlast.mailbcc = Nothing
            cBlast.mailcc = New Net.Mail.MailAddress("operations@wmdnigeria.com")
            cBlast.mailfrom = New Net.Mail.MailAddress("operations@wmdnigeria.com")
    ...
    Function getBody(streetAddress As String, City As String) As String
        Return "</html><head>" & _
...
"           <div id='row20'>" & _
"        	<div id='col36'>&nbsp;</div>" & _
"        	<div id='col37'>Name of Applicant:</div><div id='col38'>" & Request.QueryString("txtcompanyname") & "</div>" & _
"        	<div id='col37'>Address in Nigeria:</div><div id='col38'>" & streetAddress & "</div>" & _
"        	<div id='col37'>City:</div><div id='col38'>" & City & "</div>" & _
"        	<div id='col37'>Permit Quarter:</div><div id='col38'>" & Request.QueryString("txtexportPermitName") & "</div>" & _
"        	<div id='col37'>Product Description:</div><div id='col38'>" & Request.QueryString("txtProducName") & "</div>" & _
"        	<div id='col37'>Export Quantity (bbl):</div><div id='col38'>" & Request.QueryString("txtQuatity") & "</div>" & _
"        	<div id='col37'>F.O.B Value (USD):</div><div id='col38'>" & Request.QueryString("txtAmtUS") & "</div>" & _
"        	<div id='col37'>Port of Export:</div><div id='col38'>" & Request.QueryString("txtusername17") & "</div>" & _
"        	<div id='col37'>Period Covered:</div><div id='col38'>" & Request.QueryString("cboPCF") & "-" & Request.QueryString("cboPCT") & "</div>" & _
"        	<div id='col37'>Proposed date of Export:</div><div id='col38'>" & Request.QueryString("txtDPTTo") & "</div>" & _
"        	<div id='col37'>Name of Exporter:</div><div id='col38'>" & Request.QueryString("txtAsnwer") & "</div>" & _
"        </div>" & _
...
"</html>   "
    ...
    Function getBody1(CompanyName As String, FOBAmount As Double) As String
...
"        	<div id='col6'>" & Request.QueryString("txtamtPerBarrel") & "</div>" & _
"        </div>" & _
"    	<div id='row5'>" & _
"        	<div id='row8'>" & _
...
"        	<div id='col18'>" & Request.QueryString("cboPCF") & "-" & Request.QueryString("cboPCT") & "</div>" & _
"        </div>" & _
"    	<div id='row8'>&nbsp;</div>" & _
"    	<div id='row12'>" & _
...
"        </div>" & _
"    	<div id='row11'>" & _
"        	<div id='col24'>" & Request.QueryString("txtQuatity") & "</div>" & _
"        	<div id='col25'>" & Request.QueryString("txtAmtUS") & " </div>" & _
"        	<div id='col26'>" & Request.QueryString("txtProducName") & "</div>" & _
