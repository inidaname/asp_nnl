...
Public Class _default13
    ...
    Protected Sub ProceedRegistration_Click(sender As Object, e As EventArgs) Handles ProceedRegistration.Click
        Try
            ...
            Dim com As New MySqlCommand
            com.Connection = conn
            com.CommandText = "INSERT INTO deviceservices (companyID,companyName,deviceTypeAndNumber,serviceGroup,amount,transCode,registrationDate,registrationTime) VALUE ('" & Session("UserLoginID") & "','" & Session("UserLoginCompanyName") & "','" & SelectInstrument.SelectedItem.Text & "','" & ServiceGroup.SelectedItem.Text & "','" & Session("AmountDue") & "','" & Session("referenceCode") & "','" & TodaysDate() & "','" & CurrentTim() & "')"
            com.ExecuteNonQuery()
