...
Public Class _default21
    ...
    Protected Sub GetDate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles GetDate.Click
        ...
        Else
            ...
            Dim FormatStartDate = Date.ParseExact(FilterDateFrom.Text, "d-MM-yyyy", Nothing)
            Dim FormatEndDate = Date.ParseExact(FilterDateTo.Text, "d-MM-yyyy", Nothing)
            ...
            Try
                Dim SelectedDate = Date.ParseExact(FilterDateFrom.Text, "d-MM-yyyy", Nothing)
                ...
                DateDifference = Date.ParseExact(FilterDateTo.Text, "d-MM-yyyy", Nothing) - Date.ParseExact(FilterDateFrom.Text, "d-MM-yyyy", Nothing)
