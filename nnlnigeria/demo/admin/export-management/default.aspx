    ...
    <header>
        ...
        <div class="overall-container">
            <div class="sidebar">
                <nav>
                    <ul>
                        ...
                        <asp:Panel ID="ExportPermitManagementLink" runat="server" CssClass ="PanelDiv"><li class="active" style="background-image:url(../../../images/data.png) ;background-repeat:no-repeat; background-position: 10px 10px; background-size:30px 30px; "><a href="./"><span>Export Permit Management</span></a></li></asp:Panel>
            ...
            <div class="dashboard-container">
                        ...
                        <div class ="dashboard-title">Export Permit Management</div>
