            ...
            Try
                ...
                If reader.HasRows = 0 Then
                    ...
                    If PatternOfApprovalUpload.HasFile = True And PeriodicVerificationUpload.HasFile = False Then
                        ...
                        com.Connection = conn
                        com.CommandText = "INSERT INTO deviceregistration (companyID,companyName,companyAddress,city,lga,state,pobox,companyEmail,companyWebsite,modelNumber,serialNumber,manufactureNumber,registrationDate,registrationTime,deviceAmount,actualMeasure,sector,instrumentCategory,deviceType,deviceModelName,transCode,dApprovalPattern,dPeriodicCertificate,applyForCertificate,applyForVerificationCert,location,unitOfMeasureID,measurementRange,NoDelete,dApprovalPatternFile) VALUES ('" & Session("UserLoginID") & "','" & UserNameOfCompany & "','" & UserAddress & "','" & UserCity & "','" & UserLGA & "','" & UserState & "','" & UserPOBox & "','" & UserEmail & "','" & UserWebsite & "','" & ModelNo.Text & "','" & SerialNo.Text & "','" & Manufacturer.Text & "','" & TodaysDate() & "','" & CurrentTim() & "','" & Session("TotalAmount") & "','" & ActualMeasure.Text & "','" & Sector.SelectedItem.Text & "','" & Instrument.SelectedItem.Text & "','" & InstrumentType.SelectedItem.Text & "','" & ModelName.Text & "','" & Session("referenceCode") & "','" & ApprovalCertificat & "','" & VerificationCertificat & "','" & ApplyApprovalCertificat & "','" & ApplyForVerificationCertificat & "','" & Location.Text & "','" & Measurement.SelectedItem.Text & "','" & MeasurementRang.SelectedItem.Text & "','" & NoDelete & "','" & PatternOfApprovalUpload.FileName & "')"
                        com.ExecuteNonQuery()
                    ...
                    ElseIf PatternOfApprovalUpload.HasFile = False And PeriodicVerificationUpload.HasFile = True Then
                        ...
                        Dim com As New MySqlCommand
                        com.Connection = conn
                        com.CommandText = "INSERT INTO deviceregistration (companyID,companyName,companyAddress,city,lga,state,pobox,companyEmail,companyWebsite,modelNumber,serialNumber,manufactureNumber,registrationDate,registrationTime,deviceAmount,actualMeasure,sector,instrumentCategory,deviceType,deviceModelName,transCode,dApprovalPattern,dPeriodicCertificate,applyForCertificate,applyForVerificationCert,location,unitOfMeasureID,measurementRange,NoDelete,dPeriodicCertificateFile) VALUES ('" & Session("UserLoginID") & "','" & UserNameOfCompany & "','" & UserAddress & "','" & UserCity & "','" & UserLGA & "','" & UserState & "','" & UserPOBox & "','" & UserEmail & "','" & UserWebsite & "','" & ModelNo.Text & "','" & SerialNo.Text & "','" & Manufacturer.Text & "','" & TodaysDate() & "','" & CurrentTim() & "','" & Session("TotalAmount") & "','" & ActualMeasure.Text & "','" & Sector.SelectedItem.Text & "','" & Instrument.SelectedItem.Text & "','" & InstrumentType.SelectedItem.Text & "','" & ModelName.Text & "','" & Session("referenceCode") & "','" & ApprovalCertificat & "','" & VerificationCertificat & "','" & ApplyApprovalCertificat & "','" & ApplyForVerificationCertificat & "','" & Location.Text & "','" & Measurement.SelectedItem.Text & "','" & MeasurementRang.SelectedItem.Text & "','" & NoDelete & "','" & PeriodicVerificationUpload.FileName & "')"
                        com.ExecuteNonQuery()
                    ...
                    ElseIf PatternOfApprovalUpload.HasFile = True And PeriodicVerificationUpload.HasFile = True Then
                        ...
                        Dim com As New MySqlCommand
                        com.Connection = conn
                        com.CommandText = "INSERT INTO deviceregistration (companyID,companyName,companyAddress,city,lga,state,pobox,companyEmail,companyWebsite,modelNumber,serialNumber,manufactureNumber,registrationDate,registrationTime,deviceAmount,actualMeasure,sector,instrumentCategory,deviceType,deviceModelName,transCode,dApprovalPattern,dPeriodicCertificate,applyForCertificate,applyForVerificationCert,location,unitOfMeasureID,measurementRange,NoDelete,dApprovalPatternFile,dPeriodicCertificateFile) VALUES ('" & Session("UserLoginID") & "','" & UserNameOfCompany & "','" & UserAddress & "','" & UserCity & "','" & UserLGA & "','" & UserState & "','" & UserPOBox & "','" & UserEmail & "','" & UserWebsite & "','" & ModelNo.Text & "','" & SerialNo.Text & "','" & Manufacturer.Text & "','" & TodaysDate() & "','" & CurrentTim() & "','" & Session("TotalAmount") & "','" & ActualMeasure.Text & "','" & Sector.SelectedItem.Text & "','" & Instrument.SelectedItem.Text & "','" & InstrumentType.SelectedItem.Text & "','" & ModelName.Text & "','" & Session("referenceCode") & "','" & ApprovalCertificat & "','" & VerificationCertificat & "','" & ApplyApprovalCertificat & "','" & ApplyForVerificationCertificat & "','" & Location.Text & "','" & Measurement.SelectedItem.Text & "','" & MeasurementRang.SelectedItem.Text & "','" & NoDelete & "','" & PatternOfApprovalUpload.FileName & "','" & PeriodicVerificationUpload.FileName & "')"
                        com.ExecuteNonQuery()
                    ...
                    ElseIf PatternOfApprovalUpload.HasFile = False And PeriodicVerificationUpload.HasFile = False Then
                        ...
                        Dim com As New MySqlCommand
                        com.Connection = conn
                        com.CommandText = "INSERT INTO deviceregistration (companyID,companyName,companyAddress,city,lga,state,pobox,companyEmail,companyWebsite,modelNumber,serialNumber,manufactureNumber,registrationDate,registrationTime,deviceAmount,actualMeasure,sector,instrumentCategory,deviceType,deviceModelName,transCode,dApprovalPattern,dPeriodicCertificate,applyForCertificate,applyForVerificationCert,location,unitOfMeasureID,measurementRange,NoDelete) VALUES ('" & Session("UserLoginID") & "','" & UserNameOfCompany & "','" & UserAddress & "','" & UserCity & "','" & UserLGA & "','" & UserState & "','" & UserPOBox & "','" & UserEmail & "','" & UserWebsite & "','" & ModelNo.Text & "','" & SerialNo.Text & "','" & Manufacturer.Text & "','" & TodaysDate() & "','" & CurrentTim() & "','" & Session("TotalAmount") & "','" & ActualMeasure.Text & "','" & Sector.SelectedItem.Text & "','" & Instrument.SelectedItem.Text & "','" & InstrumentType.SelectedItem.Text & "','" & ModelName.Text & "','" & Session("referenceCode") & "','" & ApprovalCertificat & "','" & VerificationCertificat & "','" & ApplyApprovalCertificat & "','" & ApplyForVerificationCertificat & "','" & Location.Text & "','" & Measurement.SelectedItem.Text & "','" & MeasurementRang.SelectedItem.Text & "','" & NoDelete & "')"
                        com.ExecuteNonQuery()
