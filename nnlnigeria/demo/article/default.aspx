<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="default.aspx.vb" Inherits="WMDPortal._default23" %>
...
<head id="Head1" runat="server">
    ...
    $(function(){
        $(".news").each(function(i){
            ...
            if(len>770)
            {
                $(this).text($(this).text().substr(0,770)+'...');
            }
        });
    });
        ...
        <asp:Panel ID="DepositPanel" runat ="server" CssClass ="content-container"  style="background:rgb(245,245,245)">
            ...
            <div class ="general-form" style="margin:0px;padding:0px;width:100%;margin-bottom:30px;background:rgb(245,245,245);">
                ...
                <div class="news-frame">
                    <asp:Repeater ID="GetNewsPreview" runat="server">
                        <ItemTemplate>
                            <a class="news-preview-container" href='<%# String.Format("news-reader/?article-id={0}", Eval("ID"))%>'>
                                <div class="news-preview-container" >
                                    ...
                                    <div>
                                        <img src='<%# String.Format("../images/article/{0}", Eval("imageLink"))%>'/>
                    ...
                    <div class="navigation">
                        <input id="txtHidden" hidden="hidden" style="width:28px" value="0" runat="server" />
		                <asp:LinkButton ID="lnkBtnPrev" runat="server" Font-Underline="False" OnClick="lnkBtnPrev_Click" CssClass="mbtn" Font-Bold="True"><< Prev </asp:LinkButton>
		                <asp:LinkButton ID="lnkBtnNext" runat="server" Font-Underline="False" OnClick="lnkBtnNext_Click" CssClass="mbtn" style="float:right;" Font-Bold="True">Next >></asp:LinkButton>
                    </div>
                </div>
